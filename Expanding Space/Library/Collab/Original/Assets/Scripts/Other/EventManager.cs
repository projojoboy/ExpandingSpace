...
public class EventManager : MonoBehaviour
{
    ...
    public static void StartGame()
    {
        ...
        {
            onStartGame();
            GameObject.Find("Player(clone)").GetComponent<ShowGoToPlanet>().text1 = true;
            GameObject.Find("Player(clone)").GetComponent<ShowGoToPlanet>().text2 = true;
            GameObject.Find("Player(clone)").GetComponent<ShowGoToPlanet>().text3 = true;
        }
    }
